      ...
      <div className="min-h-screen pt-12 pb-32" style={{ backgroundColor: dm ? D.bg : '#f9fafb' }}>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 p-4 border-t"
          ...
          <div className="max-w-2xl mx-auto space-y-2">
            {brief.external_url ? (
              <a href={brief.external_url} target="_blank" rel="noopener noreferrer"
                className="w-full py-4 rounded-xl text-sm font-semibold border flex items-center justify-center gap-2 transition-all hover:opacity-80"
                style={{ borderColor: dm ? D.border : '#e5e7eb', color: dm ? D.text : '#374151', backgroundColor: dm ? D.card : 'white' }}>
                자세히 알아보기 <ChevronRight size={15} />
              </a>
            ) : null}
