...
function WritePage() {
  ...
  return (
    <div className="min-h-screen pt-12 flex flex-col" style={{ backgroundColor: dm ? D.bg : 'white' }}>
      ...
      {/* 모바일: 탭바(64px) 위에 툴바, PC: 일반 sticky */}
      <div className="fixed left-0 right-0 border-t z-[45] lg:sticky lg:bottom-0 lg:z-40"
        style={{ bottom: 64, backgroundColor: dm ? D.card : 'white', borderColor: dm ? D.border : '#f3f4f6' }}>
