        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div className="relative">
                <select value={form.category} onChange={e => set('category', e.target.value)} className={inputClass + " appearance-none pr-7"} style={inputStyle} style={inputStyle}>
...
function MarketPage() {
  ...
  return (
    <div className="min-h-screen pt-12 pb-20 lg:pb-0 flex flex-col items-center justify-center px-4"
              ...
              <div className="max-w-2xl mx-auto w-full">
                <div className="flex flex-col items-center gap-2 mb-5">
                  ...
                  <img
                    src="/ment2.svg"
                    alt="캐치카피"
                    className="w-full max-w-[240px] sm:max-w-xs md:max-w-sm lg:max-w-md"
          ...
          {[
            {
              id: 'home', label: '홈',
              icon: (active: boolean) => (
                <svg width="26" height="26" viewBox="0 0 24 24" fill={active ? KEY : (dm ? D.muted : '#9ca3af')}>
            ...
            <button key={t.id}
              onClick={() => navigate(t.id === 'home' ? '/catchcopy' : t.id === 'mypage' ? '/catchcopy/mypage' : `/catchcopy/${t.id}`)}
              className="flex flex-col items-center justify-center gap-1 transition-colors">
              {t.icon(activeTab === t.id || (t.id === 'mypage' && location.pathname === '/catchcopy/mypage'))}
              <span className="text-[10px] font-medium" style={{ color: (activeTab === t.id || (t.id === 'mypage' && location.pathname === '/catchcopy/mypage')) ? KEY : (dm ? D.muted : '#9ca3af') }}>{t.label}</span>
            </button>
          ))}
        </div>
      </nav>
